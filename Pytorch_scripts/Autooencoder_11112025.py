...
###Create a set of reproducible results
    ...
    def __init__(self, nrow=121, ncol=104, latent_dim=LATENT_DIM_DEFAULT, base_channels=CHANNELS_DEFAULT,
        ...
        if extra_conv:
            self.encoder = nn.Sequential(
                ...
                nn.BatchNorm2d(c1),  #Oceane, Note this is a new feature of this autoencoder
        ...
        self.to_latent = nn.Sequential(
            nn.Linear(flat_size, latent_dim * 2),  #Oceane, why the factor of 2?
            nn.ReLU(inplace=True),
...
#Oceane, it looks like we normalize the images between 0 and 1 before feeding them
#  to the autoencoder.  Why is the sigmoid layer important to remove then?
...
# end of compare_autoencoder_performance
