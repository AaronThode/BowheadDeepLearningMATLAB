#!/usr/bin/env python3
"""
Generate UMAP and t-SNE Embeddings for v08 Dataset
OPTIMIZED FOR SPEED - 100K SAMPLES

This script:
1. Loads latent embeddings from v08 model
2. Computes UMAP embeddings (fast, 2-5 min)
3. Computes t-SNE embeddings (slower, 10-20 min)
...
Expected total time: 15-25 minutes for 100K samples
"""
...
# Dataset directory - v08 Combined 100K
DATASET_DIR = '/Users/oceaneboulais/Github/ThodeLab/BowheadDeepLearningMATLAB/results/Autoencoder_v08_100E_32LD_CombinedDatasets_100K_Date20251125-171340.dir'
...
UMAP_PARAMS = {
    ...
    #   - None: Auto-determined based on dataset size (~500 for 100k)
...
# t-SNE Parameters - Optimized for speed with 100K samples
TSNE_PARAMS = {
    'n_components': 2,           # 2D output
    'perplexity': 30,            # Standard for large datasets
    'learning_rate': 200,        # 'auto' would be ~8333 for 100k, 200 is faster
    'max_iter': 500,             # Reduced from 1000 default for speed (renamed from n_iter)
...
print("="*80)
print("GENERATE UMAP AND t-SNE EMBEDDINGS FOR v08 DATASET")
print("="*80)
...
output_data = {
    ...
    'dataset_name': 'v08_CombinedDatasets_100K',
