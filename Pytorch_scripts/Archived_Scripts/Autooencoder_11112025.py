...
#Enable the toggling of the original autoencoder model
ORIGINAL_AUTOENCODER_ENABLED = False
...
# Recreate the  original autoencoder
...
def compare_autoencoder_performance(data_dir: str | list[str], n_samples: int = 8, normalize: bool = True,
                                    ...
                                    improved_only: bool = not ORIGINAL_AUTOENCODER_ENABLED,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--improved-only", action='store_true', default=not ORIGINAL_AUTOENCODER_ENABLED,
                       help=f"Skip original model training and plots; hide MSE comparison (default: {not ORIGINAL_AUTOENCODER_ENABLED})")
    parser.add_argument("--include-original", dest='improved_only', action='store_false',
                       help="Include original model training and comparison plots")
