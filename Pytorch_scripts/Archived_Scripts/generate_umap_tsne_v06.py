#!/usr/bin/env python3
"""
Generate UMAP and t-SNE Embeddings for v06 Dataset (MostlyManual 50K)
OPTIMIZED FOR SPEED - 50K SAMPLES

This script:
1. Loads latent embeddings from v06 model
...
- Optimized hyperparameters for 50K dataset
...
UMAP_PARAMS = {
    ...
    #   - None: Auto-determined based on dataset size (~400 for 50k)
    #   - More epochs = better optimization but slower
    #   - Here: 200 = significant speedup (2x faster) with minimal quality loss
    'n_epochs': 200,
...
TSNE_PARAMS = {
    ...
    'learning_rate': 200,        # Fast learning rate (auto would be ~4167 for 50k)
...
output_data = {
    ...
    'dataset_name': 'v06_MostlyManual_50K',
