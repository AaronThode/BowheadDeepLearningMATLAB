    ...
    if improved_only:
        ...
        try:
            ...
            if n >= 2:
                ...
                # Try simple KMeans clustering into k groups; fallback to sign/median split
                try:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data-dir", default="/Users/oceaneboulais/Github/ThodeLab/BCB_Whale_Datasets/Unsupervised_database_ManyAirguns.dir", help="Root folder containing .mat files")
